...
- Discord delivery: private/single-POV asset reveals must never fall back to a
  ...
  non-spoiling error.
- CLI delivery: safe captions and safe logical refs may print; source paths,
  unrevealed filenames, hidden labels, and unsafe delivery refs must not print.
