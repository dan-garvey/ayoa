...
class TestLLMConfig:
    ...
    def test_defaults_use_reviewed_openai_models_for_live_roles(self):
        ...
        assert config.role_models["agent"] == "gpt-5.6-luna"
        assert config.role_models["agent_standard"] == "gpt-5.6-luna"
        assert config.role_models["agent_convenience"] == "gpt-5.6-luna"
        ...
        assert config.openai_reasoning_effort_for_role("agent") == "max"
        assert config.openai_reasoning_effort_for_role("agent_standard") == "max"
        assert config.openai_reasoning_effort_for_role("agent_convenience") == "max"
